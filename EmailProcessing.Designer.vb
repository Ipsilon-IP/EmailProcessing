...
Partial Public NotInheritable Class EmailProcessing
...
Partial Friend NotInheritable Class Globals
    ...
    Private Shared _EmailProcessing As EmailProcessing
    ...
    Friend Shared Property EmailProcessing() As EmailProcessing
        Get
            Return _EmailProcessing
        End Get
        Set
            If (_EmailProcessing Is Nothing) Then
                _EmailProcessing = value
            Else
    ...
    Friend Shared ReadOnly Property FormRegions() As ThisFormRegionCollection
        Get
            If (_ThisFormRegionCollection Is Nothing) Then
                _ThisFormRegionCollection = New ThisFormRegionCollection(Globals.EmailProcessing.GetFormRegions)
            End If
...
Partial Friend NotInheritable Class ThisFormRegionCollection
    ...
    Friend Overloads Default ReadOnly Property Item(ByVal explorer As Microsoft.Office.Interop.Outlook.Explorer) As WindowFormRegionCollection
        Get
            Return CType(Globals.EmailProcessing.GetFormRegions(explorer, GetType(WindowFormRegionCollection)),WindowFormRegionCollection)
        End Get
    End Property
    ...
    Friend Overloads Default ReadOnly Property Item(ByVal inspector As Microsoft.Office.Interop.Outlook.Inspector) As WindowFormRegionCollection
        Get
            Return CType(Globals.EmailProcessing.GetFormRegions(inspector, GetType(WindowFormRegionCollection)),WindowFormRegionCollection)
        End Get
    End Property
End Class
